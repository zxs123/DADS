...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%= basePath %>images/common/title_arrow.gif"/> 修改角色信息
        </div>
...
<!--显示表单内容-->
<div id="MainArea">
    <form action="<%=basePath %>manage/EditPost" method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><input type="text" name="name" value="${role.name }" class="InputStyle" /> *</td>
                    </tr>
                    <tr>
                        <td>角色说明</td>
