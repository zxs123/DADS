...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%= basePath %>images/common/title_arrow.gif"/> 新增职务
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <form action="<%= basePath %>manage/addPosition">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                    <td>职务名称</td>
                        <td><input type="text" id="positionName" name="positionName" class="InputStyle"/> *</td>
                    </tr>
                    <tr>
                    <td>职务描述</td>
                       ...
                       <tr>
                    <td>备注</td>
                        <td><textarea id="remark" name="remark" class="TextareaStyle"></textarea></td>
                    </tr>
