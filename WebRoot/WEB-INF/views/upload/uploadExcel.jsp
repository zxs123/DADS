...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%= basePath %>images/common/title_arrow.gif"/> 选择excel表单
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <form id="searchForm" action="<%= basePath %>report/uploadExcel" method="post" ">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                    	<span class="sub_ip" style="width:160px;">
                    		<input type="button" id="image3"  class="text_an" value="上传excel表格" style="width:100px;height:30px;" />
                    	</span>
...
<div class="Description">
    上传而excel的步骤：<br />
    &nbsp&nbsp&nbsp&nbsp&nbsp 1. 点击上传excel表进行初始化；<br />
    &nbsp&nbsp&nbsp&nbsp&nbsp 2. 点击提交，完成excel表的最后上传。<br />
</div>
