...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%= basePath %>images/common/title_arrow.gif"/> 批量认领对私存款客户
        </div>
...
<form id="searchForm" method="post" action="<%= basePath %>report/addDsfpbByExcelcs">
