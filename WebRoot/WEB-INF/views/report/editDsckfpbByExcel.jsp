...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%= basePath %>images/common/title_arrow.gif"/> 批量修改对私存款客户
        </div>
        <div id="Title_End"></div>
    </div>
</div>

<form id="searchForm" method="post" action="<%= basePath %>report/editDsfpbByExcel">
			...
			<input type="hidden" id="type" name="type" value="DSCK"/>
			<div class="mm_lbgltb">
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <thead>
            <tr align=center valign=middle id=TableTitle>
                ...
                <td width="100">领出员工姓名</td>
                <td width="100">领出员工号</td>
                <td width="100">领入员工姓名</td>
                <td width="100">领入员工号</td>
